    ...
    return (
        <div className='p-5 lg:px-16  ques-ans'>
            ...
            <div className='p-2  rounded m-2'>
                ...
                <img className='rounded mt-2 w-96' src="https://daqxzxzy8xq3u.cloudfront.net/wp-content/uploads/2019/09/12115024/initialize-react-state-react-usestate-1024x447.png" alt="" />
                <p className='mt-3'>
